...
<CardGroup cols={2}>
  ...
  >
    Register a sandbox account with Petter to test out the APIs
  </Card>
  <Card
    title="API Documentation"
    icon="code"
    href="https://petter.mintlify.app/api-reference/introduction"
  >
